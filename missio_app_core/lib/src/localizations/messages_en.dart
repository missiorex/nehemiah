...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(title) => 'Deleted "$title"';
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
        ...
        'activeCampaigns':
            MessageLookupByLibrary.simpleMessage('Active Campaigns'),
        'addCampaign': MessageLookupByLibrary.simpleMessage('Add Campaign'),
        'completedCampaigns':
            MessageLookupByLibrary.simpleMessage('Completed Campaigns'),
        'deleteCampaign':
            MessageLookupByLibrary.simpleMessage('Delete Campaign'),
        'deleteCampaignConfirmation':
            MessageLookupByLibrary.simpleMessage('Delete this campaign?'),
        'editCampaign': MessageLookupByLibrary.simpleMessage('Edit Campaign'),
        'emptyCampaignError':
            MessageLookupByLibrary.simpleMessage('Please enter some text'),
        'filterCampaigns':
            MessageLookupByLibrary.simpleMessage('Filter Campaigns'),
        'newCampaignHint':
            MessageLookupByLibrary.simpleMessage('What needs to be done?'),
        'descriptionHint':
